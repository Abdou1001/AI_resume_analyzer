                    ...
                    {file ?
                        (
                            <div className="uploader-selected-file" onClick={(e) => e.stopPropagation()}>
                                <img src="public/images/pdf.png" alt="pdf img" className='size-10' />
                        ...
                        (
                            <div>
                                <div className='mx-auto w-16 h-16 flex items-center justify-center'>
                                    <img src="public/icons/info.svg" alt="upload" className='size-20 mb-4' />
                                </div>
                                <p className='text-lg text-gray-500'>
                                    <span className='font-bold'>Cilck to upload</span>
                                    or drag and drop
                                </p>
                                <p className='text-lg text-gray-500'>
